...
void VoxbloxESDFScanMatcher::evaluateScanMatcher(const cartographer::sensor::PointCloud& scan_cloud,
  ...
  cartographer::mapping_3d::scan_matching::CeresVoxbloxESDFScanMatcher voxblox_scan_matcher(ceres_scan_matcher_options, config_.cubic_interpolation, config_.boundary_extrapolation);
  ...
  if(config_.publish_cloud) {
    ...
    cartographer::mapping_3d::scan_matching::InterpolatedVoxbloxESDF interpolated_voxblox_esdf(voxblox_esdf, max_truncation_distance, config_.cubic_interpolation, config_.boundary_extrapolation);
